...
SECRET_KEY = 'django-insecure-x#gqwv%$lo82r0_zo*-d4ls#a(2hnd%e)&h3&vkp5$5kyksqze'
...
ALLOWED_HOSTS = ['dev-app.gpavilion.org', 'staging-app.gpavilion.org', '127.0.0.1', 'localhost']
